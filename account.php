...
if( isset($_COOKIE['user']) ){
    ...
    if ($conn->connect_errno) {
        ...
        if($usertype == 'regular'){
            ...
            <div class='advertisement'>Non premium user. Click <a href='upgrade.html'>here</a> to upgrade!</div>");
        }
        else {
            echo("<div class='userInfo' id='userEmail'>Email: $_COOKIE['user']</div>
            <div class='userInfo' id='numFavs'>Max Favorites: Unlimited</div>
            <div class='advertisement'>Premium user. Thank you for supporting Centros!</div>");
        }
}
else {
